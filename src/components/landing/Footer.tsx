    ...
    <footer className="bg-foreground py-10 px-4">
      ...
      <div className="flex justify-center gap-4 mt-6">
        {[
          ...
          <a key={s.name} href="#" className="w-10 h-10 rounded-full border border-white/20 flex items-center justify-center text-white/50 text-xs font-bold hover:bg-white/10 hover:text-white transition-all">
            {s.icon}
          </a>
        ))}
      </div>
