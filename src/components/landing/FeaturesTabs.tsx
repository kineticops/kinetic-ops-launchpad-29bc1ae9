...
const FEATURES = [
  {
    tab: "AGENDA CITAS",
    heading: "Tus pacientes agendan solos por WhatsApp",
    ...
    bullets: [
      ...
      { bold: "Reprogramaciones y cancelaciones", rest: " gestionadas automáticamente." },
    ],
    messages: [
      { from: "bot" as const, text: "¡Hola! 👋 ¿Qué servicio necesitas?\n\n🦷 Limpieza\n✨ Blanqueamiento\n🔧 Empaste\n📋 Revisión general", time: "10:00" },
      { from: "user" as const, text: "Limpieza dental", time: "10:01" },
      { from: "bot" as const, text: "🦷 Horarios disponibles:\n\n📅 Lunes 10:00h\n📅 Miércoles 16:30h\n📅 Jueves 17:30h\n\n¿Cuál te viene mejor?", time: "10:01" },
      { from: "user" as const, text: "Jueves 17:30", time: "10:02" },
      { from: "bot" as const, text: "✅ ¡Cita confirmada!\n\n📅 Jueves 3 abril — 17:30h\n🦷 Limpieza dental\n📍 Clínica Dental Sonríe\n\n🔔 Te avisaré 24h antes 😊", time: "10:02" },
    ],
  },
  {
    tab: "RECORDATORIOS",
    heading: "Reduce un 60% los no-shows automáticamente",
    subheading: "Sin que tu equipo tenga que acordarse de nada.",
    bullets: [
  ...
  },
  {
    ...
    bullets: [
      ...
      { bold: "Precios y servicios", rest: " disponibles 24/7." },
      { bold: "Derivación inteligente", rest: " a un humano cuando hace falta." },
      { bold: "Tono personalizado", rest: " de tu clínica." },
    ],
    messages: [
      { from: "user" as const, text: "Hola, ¿cuánto cuesta un blanqueamiento?", time: "23:45" },
      { from: "bot" as const, text: "¡Hola! 😊\n\n✨ Blanqueamiento LED profesional\n💰 Desde 249€\n⏱ 1h aprox.\n\nIncluye diagnóstico + kit de mantenimiento.\n\n¿Agendo una consulta gratuita?", time: "23:45" },
      { from: "user" as const, text: "Sí, el lunes", time: "23:46" },
      { from: "bot" as const, text: "📅 Lunes disponible:\n\n🕐 09:30h\n🕐 11:00h\n🕐 16:00h\n\n¿Cuál prefieres?", time: "23:46" },
      ...
      <div ref={ref} className="fade-section max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div className="flex justify-center order-2 lg:order-1">
            <WhatsAppChat key={active} messages={f.messages} contactName="Clínica Dental Sonríe" contactSubtitle="Asistente Virtual · En línea" />
          </div>
          <div className="order-1 lg:order-2">
            <h3 className="text-foreground text-2xl sm:text-3xl font-bold mb-2 leading-snug">{f.heading}</h3>
            ...
            <a href="#form" className="inline-flex items-center gap-2 bg-primary text-primary-foreground px-8 py-3.5 rounded-full font-bold text-base hover:shadow-lg hover:shadow-primary/20 transition-all hover:-translate-y-0.5">
